...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["jsmind"], e)
    : e((t = "undefined" != typeof globalThis ? globalThis : t || self).jsMind);
})(this, function (t) {
  "use strict";
  function e(t) {
  ...
  class h {
    constructor(t, e) {
      var s = {};
      i.default.util.json.merge(s, n),
        i.default.util.json.merge(s, e),
        (this.version = "0.4.0"),
        (this.jm = t),
        (this.options = s),
        (this.e_canvas = null),
    ...
    dragstart(t) {
      if (this.jm.get_editable() && !this.capture) {
        ...
        var e = this.jm.view,
          i = this.find_node_element(t.target);
        if (i) {
          ...
          if (o) {
            ...
            if (!n.isroot) {
              this.reset_shadow(i),
                ...
                0 != this.hlookup_delay && s.w.clearTimeout(this.hlookup_delay),
                0 != this.hlookup_timer &&
                  s.w.clearInterval(this.hlookup_timer);
              var h = this;
              (this.hlookup_delay = s.w.setTimeout(function () {
                (h.hlookup_delay = 0),
                  (h.hlookup_timer = s.w.setInterval(function () {
      ...
      if (this.jm.get_editable() && this.capture) {
        ...
        var e = this.jm.view,
          ...
          s =
            (t.clientY || t.touches[0].clientY) / e.zoom_current -
            this.offset_y;
        t.clientY - this.view_panel_rect.top <
        ...
        this.view_panel.scrollTop > this.options.scrolling_step_length
          ? (this.view_panel.scrollBy(0, -this.options.scrolling_step_length),
            (this.offset_y +=
              this.options.scrolling_step_length / e.zoom_current))
          : this.view_panel_rect.bottom - t.clientY <
            ...
            (this.offset_y -=
              this.options.scrolling_step_length / e.zoom_current)),
          t.clientX - this.view_panel_rect.left <
            this.options.scrolling_trigger_width &&
    ...
    dragend(t) {
      if (this.jm.get_editable()) {
        if (
          (this.view_draggable && this.jm.enable_view_draggable(), this.capture)
        ) {
          if (
            (0 != this.hlookup_delay &&
              (s.w.clearTimeout(this.hlookup_delay),
              (this.hlookup_delay = 0),
              this.clear_lines()),
            0 != this.hlookup_timer &&
              (s.w.clearInterval(this.hlookup_timer),
    ...
    lookup_target_node() {
      ...
      let s =
          this.shadow_p_x + this.shadow_w / 2 >= this.get_root_x()
            ? i.default.direction.right
            : i.default.direction.left,
      ...
      if (o) {
        ...
        this.magnet_shadow(t.sp, t.np, e),
          (this.target_node = o),
          (this.target_direct = s);
      }
    }
    get_root_x() {
    ...
    shadow_on_target_side(t, e) {
      return (
        (e == i.default.direction.right &&
          this.shadow_to_right_of_node(t) > 0) ||
        (e == i.default.direction.left && this.shadow_to_left_of_node(t) > 0)
      );
    }
