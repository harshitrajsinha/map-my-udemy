...
!(function (e, t) {
  ...
  const t = {
    ...
    i = { show: 1, resize: 2, edit: 3, select: 4 },
  ...
  class h {
    ...
    add_node(e, i, n, o, r, a, d) {
      if (!l.is_node(e))
        return s.error("the parent_node " + e + " is not a node."), null;
      ...
      return (
        ...
        this._put_node(h)
          ...
          : (s.error(
              "fail, the node id '" + h.id + "' has been already exist."
            ),
            (h = null)),
        h
      );
    ...
    insert_node_before(e, t, i, n, o) {
      if (!l.is_node(e))
        return s.error("the node_before " + e + " is not a node."), null;
      var r = e.index - 0.5;
    ...
    insert_node_after(e, t, i, n, o) {
      if (!l.is_node(e))
        return s.error("the node_after " + e + " is not a node."), null;
      var r = e.index + 0.5;
      return this.add_node(e.parent, t, i, n, o, !0, r);
    }
    get_node_after(e) {
    ...
    remove_node(e) {
      if (!l.is_node(e))
        return s.error("the parameter node " + e + " is not a node."), !1;
  ...
  const _ = { name: "jsMind", author: "hizzgdev@163.com", version: e },
    u = {
      node_tree: {
        example: {
          meta: _,
        ...
        _build_node: function (e) {
          ...
          if (e instanceof l) {
            ...
            if (
              (e.parent &&
                e.parent.isroot &&
                (n.direction = e.direction == t.left ? "left" : "right"),
              null != e.data)
            ) {
              var o = e.data;
      ...
      node_array: {
        example: {
          ...
          format: "node_array",
          data: [
            { id: "root", topic: "jsMind node_array example", isroot: !0 },
          ],
        },
        get_mind: function (e) {
          var t = u.node_array,
        ...
        _parse: function (e, t) {
          ...
          o
            ? i._extract_subnode(e, o, n)
            : s.error("root node can not be found");
        },
        ...
        _extract_subnode: function (e, i, n) {
          for (
            var o = u.node_array, s = n.length, r = null, a = null, d = 0;
            s--;
        ...
        _array_node: function (e, i) {
          ...
          if (e instanceof l) {
            ...
            if (
              (e.parent && (o.parentid = e.parent.id),
              e.isroot && (o.isroot = !0),
              e.parent &&
                e.parent.isroot &&
                (o.direction = e.direction == t.left ? "left" : "right"),
              null != e.data)
            ) {
              var s = e.data;
      ...
      freemind: {
        ...
        _find_root: function (e) {
          for (
            var t = e.childNodes, i = null, n = null, o = 0;
            o < t.length;
            o++
          )
        ...
        _load_node: function (e, i, n) {
          ...
          var c = n.getAttribute("POSITION"),
            p = null;
          c && (p = "left" == c ? t.left : t.right);
          var v = null;
          v = i ? e.add_node(i, s, r, h, p, _) : e.set_root(s, r, h);
          var f = n.childNodes,
            g = null;
        ...
        _build_map: function (e, i) {
          ...
          e.parent &&
            ...
            o && i.push('POSITION="' + o + '"'),
            i.push('TEXT="' + e.topic + '">'),
            i.push('<attribute NAME="expanded" VALUE="' + e.expanded + '"/>');
          var s = e.data;
          if (null != s)
            for (var r in s)
  ...
  class c {
        ...
        (t =
          "object" == typeof e
            ? e.format
              ...
              : "node_tree"
            : "freemind")
          ? (i = u.node_array.get_mind(e))
          : "node_tree" == t
          ? (i = u.node_tree.get_mind(e))
          : "freemind" == t
          ? (i = u.freemind.get_mind(e))
          : "text" == t
          ? (i = u.text.get_mind(e))
    ...
    get_data(e) {
      ...
      return (
        "node_array" == e
          ? (t = u.node_array.get_data(this.jm.mind))
          : "node_tree" == e
          ? (t = u.node_tree.get_data(this.jm.mind))
          : "freemind" == e
  ...
  class p {
    ...
    layout_offset() {
      ...
      for (var n = e.children, o = n.length, s = [], r = [], a = null; o--; )
        (a = n[o])._data.layout.direction == t.right
          ? r.unshift(a)
          : s.unshift(a);
      (i.left_nodes = s),
        (i.right_nodes = r),
    ...
    _layout_offset_subnodes(e) {
      for (
        ...
        (r = (o = e[n])._data.layout),
          ...
          o.children.length > 1 && (s += this.opts.cousin_space),
          (r.outer_height = s),
          (r.offset_y = a - s / 2),
          (r.offset_x =
    ...
    get_min_size() {
      ...
      for (var n in e)
        (t = e[n]),
          (i = this.get_node_point_out(t)).x > this.bounds.e &&
            (this.bounds.e = i.x),
    ...
    collapse_all() {
      var e,
        ...
        i = 0;
      for (var n in t)
        (e = t[n]).expanded && !e.isroot && ((e.expanded = !1), i++);
      if (i > 0) {
        var o = this.jm.mind.root;
        this.part_layout(o), this.set_visible(o.children, !0);
      }
    ...
    expand_to_depth(e, t, i) {
      if (!(e < 1))
        for (
          var n = t || this.jm.mind.root.children,
            o = i || 1,
            s = n.length,
            r = null;
          s--;
    ...
    part_layout(e) {
      ...
      if (i) {
        ...
        e.isroot
          ? ((n.outer_height_right = this._layout_offset_subnodes_height(
              n.right_nodes
            )),
            (n.outer_height_left = this._layout_offset_subnodes_height(
              n.left_nodes
            )))
          : e._data.layout.direction == t.right
          ? (n.outer_height_right = this._layout_offset_subnodes_height(
    ...
    set_visible(e, t) {
      for (var i = e.length, n = null; i--; )
        (n = e[i])._data.layout,
          n.expanded
            ? this.set_visible(n.children, t)
            : this.set_visible(n.children, !1),
  ...
  class g {
    ...
    remove_node(e) {
      null != this.selected_node &&
        ...
        null != this.editing_node &&
          ...
          (e._data.view.element.removeChild(this.e_editor),
          (this.editing_node = null));
      for (var t = e.children, i = t.length; i--; ) this.remove_node(t[i]);
      if (e._data.view) {
    ...
    restore_location(e) {
      ...
      (this.e_panel.scrollLeft =
        parseInt(t.element.style.left) - t._saved_location.x),
        (this.e_panel.scrollTop =
          parseInt(t.element.style.top) - t._saved_location.y);
    }
    clear_nodes() {
      var e = this.jm.mind;
      if (null != e) {
    ...
    _get_expander_text(e) {
      let t = this.opts.expander_style
        ? this.opts.expander_style.toLowerCase()
        : "char";
      return "number" === t
    ...
    _custom_node_render(e, t) {
      this.opts.custom_node_render(this.jm, e, t) ||
        this._default_node_render(e, t);
    }
    ...
    _reset_node_custom_style(e, t) {
      if (
        ("background-color" in t &&
          (e.style.backgroundColor = t["background-color"]),
    ...
    restore_selected_node_custom_style(e) {
      ...
      "background-color" in i &&
        (t.style.backgroundColor = i["background-color"]),
    ...
    center_node(e) {
      if (!this.layout.is_visible(e))
        return (
          s.warn("can not scroll to the node, because it is invisible"), !1
        );
      let t = e._data.view,
  ...
  class m {
    ...
    handle_addbrother(e, t) {
      ...
      if (i && !i.isroot) {
        var n = this._newid();
        e.insert_node_after(i, n, "New Node") &&
          (e.select_node(n), e.begin_edit(n));
      }
    }
    handle_editnode(e, t) {
      var i = e.get_selected_node();
  ...
  function y(e) {
    if (!(e instanceof x))
      throw new Error(
        "can not register plugin, it is not an instance of Plugin"
      );
    if (w.plugins.map((e) => e.name).includes(e.name))
      throw new Error(
        "can not register plugin " + e.name + ": plugin name already exist"
      );
    w.plugins.push(e);
  }
  function b(e, t) {
  ...
  class z {
    ...
    _event_bind() {
      this.view.add_event(this, "mousedown", this.mousedown_handle),
        ...
        this.view.add_event(this, "mousewheel", this.mousewheel_handle, !0);
    }
    mousedown_handle(e) {
    ...
    dblclick_handle(e) {
      if (
        this.options.default_event_handle.enable_dblclick_handle &&
        this.get_editable()
      ) {
        var t = e.target || event.srcElement;
    ...
    mousewheel_handle(e) {
      if (
        ...
        var t = e || event;
        t.preventDefault(),
          t.deltaY < 0 ? this.view.zoom_in(t) : this.view.zoom_out(t);
      }
    }
    begin_edit(e) {
      if (!l.is_node(e)) {
    ...
    insert_node_before(e, n, o, r, a) {
      if (this.get_editable()) {
        var d = this.get_node(e),
          l = t.of(a);
        void 0 === l &&
          (l = this.layout.calculate_next_child_direction(d.parent));
    ...
    find_node_before(e) {
      ...
      if (e.parent.isroot)
        for (
          var n = e.parent.children, o = null, r = null, a = 0;
          a < n.length;
          a++
        )
          (r = n[a]),
            e.direction === r.direction && (e.id === r.id && (i = o), (o = r));
    ...
    find_node_after(e) {
      ...
      if (e.parent.isroot) {
        for (
          var n = e.parent.children, o = !1, r = null, a = 0;
          a < n.length;
          a++
        )
